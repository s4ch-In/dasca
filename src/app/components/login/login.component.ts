...
export class LoginComponent implements OnInit {
  ...
  ngAfterViewInit() {
    this.formDom.nativeElement.querySelector(".form-control[name='password']").focus();
    // console.log('route : ', );
  }
  login() {
    ...
    //   console.log(res)
    // })
    // this.service.authenticate(this.username, this.password).subscribe(x => console.log(x))

    Observable.of(this.service.authenticate(this.loginForm.value.password)).subscribe(res => {
      if (res.s) {
