...
export class PrintComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.rData) {
      if (this.rData.membership) {
        this.q1 = this.findByKey(this.rData.membership, 'quarter', 'q1')
        this.q2 = this.findByKey(this.rData.membership, 'quarter', 'q2')
        this.q3 = this.findByKey(this.rData.membership, 'quarter', 'q3')
        this.q4 = this.findByKey(this.rData.membership, 'quarter', 'q4')
      }
      ...
      this.finalAmount = this.rData.finalAmount
      this.amountReceived = this.rData.amountPaid
      this.balance = this.rData.balance
    }
  }
